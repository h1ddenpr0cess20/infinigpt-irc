...
This is a clone of my project, [jerkbot-irc](https://github.com/h1ddenpr0cess20/jerkbot-irc), with a more friendly name and default personality setting.  I think it's less fun, but it may be more appealing to others.
